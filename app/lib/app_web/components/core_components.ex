defmodule AppWeb.CoreComponents do
  ...
  attr :rest, :global,
    include: ~w(id autocomplete name rel action enctype method novalidate target multipart),
  ...
  attr :rest, :global,
    include:
      ~w(accept autocomplete capture cols disabled inputmode form list max maxlength min minlength
